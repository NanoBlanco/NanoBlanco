...
<section class="app-content">
    <div class="app-title">
        ...
        <div class="float-right">
            ...
            <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#staticBackdrop"><i class="fa fa-plus-circle"></i> Nueva Ubicación</button>
            <?php } ?>
        </div>
        <div class="col-lg-8">
            <?php 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm">
                        <form id="myform-general" method="post" action="<?= FOLDER_PATH.'/Ubicaciones/guardarUbicacion' ?>" class="form-horizontal" autocomplete="off">
