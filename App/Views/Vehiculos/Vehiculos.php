    ...
    <div class="app-title">
        ...
        <div class="float-right">
            <?php if(isset($_SESSION['permisos'][8]['ins']) == 1 || $_SESSION['id_rol'] = 100) {?>
                <a href="<?= FOLDER_PATH.'/Vehiculos/nuevoVehiculo' ?>" class="btn btn-outline-danger">
                            ...
                            <tbody>
                                ...
                                if(!empty($vehiculos)) {
                                    foreach ($vehiculos as $Key => $vehiculo) { ?>
                                        <tr>
                                            <td><?= substr($vehiculo['detalle_id'],0,3).'-'.substr($vehiculo['detalle_id'],3,3).'-'.substr($vehiculo['detalle_id'],6).'-'.$vehiculo['corr_vehiculo'] ?></td>
                                            <td><?= htmlentities($vehiculo['vehiculo']) ?></td>
                                            <td><?= htmlentities($vehiculo['responsable']) ?></td>
                                            <td>
                                                <div class="row">
                                                    <?php if(isset($_SESSION['permisos'][8]['updt']) == 1 || $_SESSION['id_rol'] = 100) {?>
                                                        <div class="col-auto">
                                                            <form method="post" action="<?= FOLDER_PATH.'/Vehiculos/editarVehiculo' ?>">
                                                    ...
                                                    <?php if(isset($_SESSION['permisos'][8]['dlt']) == 1 || $_SESSION['id_rol'] = 100) {?>
                                                        <div class="col-auto">
                                                            <a href="#delete_<?= $vehiculo['id']; ?>" class="btn btn-danger btn-sm" data-toggle="modal" title="Borrar">
                                            ...
                                            <?php include './App/Views/Vehiculos/Borrar.php'; ?>
                                        </tr>
                                    <?php }
                                } ?>
                            </tbody>
