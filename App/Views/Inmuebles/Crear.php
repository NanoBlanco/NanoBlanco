                ...
                <form id="example-form" action="#" class="mt-5">
                    <div>
                        ...
                        <section>
                            ...
                            <select class="selectItems custom-select shadow-none" name="item_id" id="lista1" style="width: 100%; height: 36px" required>
                            ...
                            <select class="selectSItems custom-select shadow-none" id="select2lista" name="sub_item_id" style="width: 100%; height: 36px" required>
                            </select>
                            <label for="detalle_id">Detalle</label>
                            <select class="selectDets custom-select shadow-none" id="select3lista" name="detalle_id" style="width: 100%; height: 36px" required>
                            </select>
                            <label for="codifica">Codificación</label>
                            <input id="codifica" name="codifica" type="text" required/>
                        ...
                        <section>
                            ...
                            <input id="valor" name="valor" type="number" class="form-control" required/>
                            ...
                            <input id="tipo" name="tipo" type="text" class="form-control" readonly />

                            <!-- <select class="form-control" name="tipo" id="tipo" required>
                                <option value=0>Seleccione un tipo...</option>
                                <option value=1>Patrimonial</option>
                                <option value=2>Control</option>
                                <option value=3>Fungible</option>
                            </select> -->
...
<script>
//$(".selectItems").select2();
//$(".selectSItems").select2();
//$(".selectDets").select2();
$('#select3lista').on('change', function() {
    var id2 = $('#select2lista').val();
    var id3 = $('#select3lista').val();
    alert('Codigo '+id2+'-'+id3);
})
</script>
