<!-- Modal Consulta -->
<div class="modal fade" id="consulta_<?= $inmueble['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="ConsultaLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <center>
                    <h4 class="modal-title" id="ConsultaLabel">Inmueble ?</h4>
                </center>
